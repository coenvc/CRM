...
namespace Test
{
   public class Data
    { 
       ...
       public IEmployee SearchEmployeeFirstName(string firstname)
       {
           IEmployee e =  employees.First(s => s.Firstname == firstname);

            return e;
        }
        public IEmployee SearchEmployeeByLastname(string lastname)
        {
            IEmployee e = employees.First(s => s.Lastname == lastname);
